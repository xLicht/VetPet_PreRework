...
namespace VetPet_
{
    public partial class MenuServicios : Form
    {
        ...
        {
            parentForm.formularioHijo(new ListaServicios(parentForm)); // Pasamos la referencia de Form1 a 
        }

        private void BtnAgregarServicios_Click(object sender, EventArgs e)
        {
            parentForm.formularioHijo(new AgregarServicios(parentForm)); // Pasamos la referencia de Form1 a 
        }
    }
}
