...
namespace VetPet_
{
    public partial class VeterinariaConsultar : Form
    {
        ...
        public VeterinariaConsultar(Form1 parent)
        {
            InitializeComponent();
            parentForm = parent;  // Guardamos la referencia del formulario principal
            this.Load += VeterinariaConsultar_Load;       // Evento Load
            this.Resize += VeterinariaConsultar_Resize;   // Evento Resize
        ...
        private void VeterinariaConsultar_Resize(object sender, EventArgs e)
        {
